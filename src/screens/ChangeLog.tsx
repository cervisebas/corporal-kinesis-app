...
export class ChangeLog extends Component<IProps, IState> {
    ...
    render(): React.ReactNode {
        return(<CustomModal visible={this.props.visible} onShow={()=>this.dataLoad()} onRequestClose={()=>this.props.close()}>
                ...
                <View style={{ flex: 2 }}>
                    <FlatList
                        ...
                        renderItem={({ item, index })=><CustomItemList6
                            ...
                            style={(index == 0)? { borderWidth: 2, borderColor: Colors.green500 }: undefined}
                            subtitle={item.date}
